...
public enum ModArmorMaterials implements ArmorMaterial {
    MAJORAS("majoras_mask", 37, Util.make(new EnumMap(ArmorItem.Type.class), (map) -> {
        map.put(ArmorItem.Type.BOOTS, 8);
        map.put(ArmorItem.Type.LEGGINGS, 10);
        map.put(ArmorItem.Type.CHESTPLATE, 8);
        map.put(ArmorItem.Type.HELMET, 4);
    }), 9, ModSounds.SKULLKID_SCREAM, 2.0F, 0.1F, () -> {
        return Ingredient.ofItems(new ItemConvertible[]{ModItems.TRIFORCE});
    });
